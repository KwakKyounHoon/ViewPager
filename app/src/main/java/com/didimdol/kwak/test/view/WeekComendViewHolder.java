 ...
 */
public class WeekComendViewHolder extends RecyclerView.ViewHolder {

    ViewPager pager;
    ImagePagerAdapter mAdapter;
    ImageDatas imageData;

    public WeekComendViewHolder(View itemView, FragmentManager fragmentManager) {
        super(itemView);
        pager = (ViewPager)itemView.findViewById(R.id.pager2);
