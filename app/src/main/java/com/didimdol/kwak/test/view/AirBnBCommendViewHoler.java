 ...
 */
public class AirBnBCommendViewHoler extends RecyclerView.ViewHolder {
    ViewPager pager;
    ImagePagerAdapter mAdapter;
    ImageDatas imageData;

    public AirBnBCommendViewHoler(View itemView, FragmentManager fragmentManager) {
        super(itemView);
        pager = (ViewPager)itemView.findViewById(R.id.pager3);
